...
use DetalaseApiLib\Http\HttpCallBack;
...
class HttpCallBackCatcher extends HttpCallBack
{
    /**
     * Http request
     * @var DetalaseApiLib\Http\HttpRequest
     */
    private $request;

    /**
     * Http Response
     * @var DetalaseApiLib\Http\HttpResponse
     */
    private $response;
     ...
     * @return DetalaseApiLib\Http\HttpRequest
     */
     ...
     * @return DetalaseApiLib\Http\HttpResponse
     */
